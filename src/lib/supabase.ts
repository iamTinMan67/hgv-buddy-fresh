    ...
    Tables: {
      ...
      agency_contracts: {
        Row: {
          ...
          agency_contact_mobile: string | null;
          agency_address_line1: string;
          agency_address_line2: string | null;
          agency_address_line3: string | null;
          agency_town: string | null;
          agency_city: string;
          agency_postcode: string;
          agency_country: string;
          bank_account_name: string;
          bank_account_number: string;
          bank_sort_code: string;
          bank_name: string;
          building_society_number: string | null;
          contract_start_date: string;
          contract_end_date: string | null;
          contract_status: 'active' | 'inactive' | 'expired' | 'terminated';
